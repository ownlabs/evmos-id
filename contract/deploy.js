...
async function deploy() {
    try {
        ...
        if (
            ...
            child_process.execSync('sudo PROVIDER="' + configs.provider + '" MNEMONIC="' + configs.owner_mnemonic + '" PROXY="' + configs.owner_address + '" truffle deploy --network ' + configs.network + ' --reset', { stdio: 'inherit' })
